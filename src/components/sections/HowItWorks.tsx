...
const steps = [
  {
    ...
    description: 'Sign up and create your custom booking page. Add your branding, menu items, and available time slots.',
    color: 'primary',
  },
  {
    number: '02',
    icon: Edit3,
    title: 'Customize Menu & Packages',
    description: 'Set up your menu with photos, prices, and packages. Configure deposit requirements and cancellation policies.',
    color: 'accent',
  },
  {
    number: '03',
    ...
    description: 'Link your payment gateway to receive online payments. Customers can pay deposits or full amounts upfront.',
    color: 'primary',
  },
  {
    number: '04',
    icon: Rocket,
    title: 'Go Live',
    description: 'Share your unique booking link. Accept reservations 24/7 and manage everything from your dashboard.',
    color: 'accent',
  },
];
            ...
            <div className="bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden">
              ...
              <div className="p-6">
                <div className="grid grid-cols-2 gap-4">
                  {[
                    { name: 'Modern Cafe', type: 'Cafe & Coffee' },
                    { name: 'Fine Dining', type: 'Restaurant' },
                    { name: 'Food Truck', type: 'Street Food' },
                    { name: 'Bakery', type: 'Bakery & Desserts' },
                  ].map((template, i) => (
                    <div
                      key={i}
                      className={`rounded-xl border-2 p-4 cursor-pointer transition-all ${
                        i === 0 ? 'border-primary-500 bg-primary-50' : 'border-gray-200 hover:border-primary-300'
                      }`}
                    >
                      <div className={`w-full h-20 rounded-lg mb-3 ${
                        i === 0 ? 'bg-gradient-to-br from-primary-200 to-accent-200' :
                        i === 1 ? 'bg-gradient-to-br from-amber-200 to-orange-200' :
                        i === 2 ? 'bg-gradient-to-br from-green-200 to-teal-200' :
