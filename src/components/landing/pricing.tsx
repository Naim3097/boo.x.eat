...
const plans = [
  {
    ...
    cta: "Start Free",
    ctaClass: "text-dark-800 bg-white border-2 border-gray-200 hover:border-primary-300 hover:text-primary-700",
  },
  {
    name: "Professional",
    ...
    ctaClass: "text-white bg-gradient-to-r from-primary-700 to-primary-500 hover:from-primary-600 hover:to-primary-400 shadow-lg hover:shadow-glow",
  },
  {
    name: "Enterprise",
    ...
    cta: "Contact Sales",
    ctaClass: "text-white bg-gradient-to-r from-accent-600 to-accent-500 hover:from-accent-500 hover:to-accent-400 shadow-lg hover:shadow-glow-accent",
  },
];

const colorClasses = {
  gray: { bg: "bg-white", border: "border-gray-200", iconBg: "bg-gray-100", iconColor: "text-gray-600" },
  primary: { bg: "bg-gradient-to-b from-primary-50 to-white", border: "border-primary-200", iconBg: "bg-primary-100", iconColor: "text-primary-600" },
  accent: { bg: "bg-gradient-to-b from-accent-50 to-white", border: "border-accent-200", iconBg: "bg-accent-100", iconColor: "text-accent-600" },
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
              ...
              >
                {plan.popular && (
                  <div className="absolute -top-4 left-1/2 -translate-x-1/2">
                    <span className="inline-flex items-center rounded-full font-medium bg-primary-100 text-primary-700 px-3 py-1 text-sm shadow-lg">
                      Most Popular
                    </span>
                  </div>
                )}
                ...
                <Link
                  href="/register"
                  className={`block w-full text-center px-6 py-3 font-semibold rounded-full transition-all duration-300 transform hover:-translate-y-0.5 ${plan.ctaClass}`}
                >
                  {plan.cta}
                </Link>
              </motion.div>
        ...
        >
          <p className="text-dark-400 text-sm">
            No credit card required for free tier &bull; Cancel anytime &bull; 14-day money-back guarantee
          </p>
        </motion.div>
      </div>
    </section>
